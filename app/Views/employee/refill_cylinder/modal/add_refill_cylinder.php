<div class="modal fade bs-example-modal-lg" id="addRefillModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form" id="addRefillForm" method="post">
                    <div class="box-body">
                        <div class="row">
