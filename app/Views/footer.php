...
<script src="<?php echo base_url() . 'resource/js/jsQR.js'; ?>"></script>
...
<script src="<?php echo base_url() . 'resource/js/html5-qrcode.min.js'; ?>"></script>
<!-- <script src="<?php //echo base_url() . 'resource/js/quagga.min.js'; ?>"></script>
<script src="<?php //echo base_url() . 'resource/js/jquery.webcam.js'; ?>"></script> -->