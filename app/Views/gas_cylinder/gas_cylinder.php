                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-header with-border box-controls pull-right">
                            ...
                            <button type="button" class="btn btn-primary" id="addCylinderBtn">Add Gas Cylinder</button>
                        ...
                        <div class="box-body">
                            <div class="table-responsive">
                                <table id="gasCylinderTable" class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>Sr No</th>
                                            <th>Cylinder No</th>
